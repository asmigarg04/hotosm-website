...
Program-summary:
  Program Summary Text: |+
    ...
    <a>**Our goal is to use open maps and data to strengthen humanitarian efforts in complex emergencies, helping to deliver life-saving aid and support projects for vulnerable communities.**</a>
